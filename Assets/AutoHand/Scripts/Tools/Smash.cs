...
namespace Autohand.Demo
{
    ...
    {
        [Header("Smash Options")] [Tooltip("Required velocity magnitude from Smasher to smash")]
        public float smashForce = 1;

        [Tooltip("Whether or not to destroy this object on smash")]
        public bool destroyOnSmash = false;

        [Tooltip("Whether or not to release this object on smash")] [HideIf("destroyOnSmash")]
        public bool releaseOnSmash = false;

        [Header("Particle Effect")] [Tooltip("Plays this effect on smash")]
        ...
        [Header("Sound Options")] public AudioClip smashSound;
        ...
        public void DoSmash(Smasher smash)
        {
            ...
            if (destroyOnSmash)
            {
                if (GetComponent<RealtimeView>() != null)
