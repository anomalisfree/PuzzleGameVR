...
{
    [RealtimeModel]
    public partial class InteractableObjectsDataModel
    {
...
namespace Main.Scripts.ApplicationCore.RealtimeModels {
    public partial class InteractableObjectsDataModel : RealtimeModel {
        ...
        public InteractableObjectsDataModel() : base(null) {
